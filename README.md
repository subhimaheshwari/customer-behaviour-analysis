...
1. Create database (PostgreSQL/MySQL/SQL Server)
2. Load cleaned CSV into database
3. Run SQL scripts from `/sql_queries/`
...
If you want, I can also generate a **template Power BI dashboard summary** or **SQL query library** for this repo!
